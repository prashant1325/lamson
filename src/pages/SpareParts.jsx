      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-10 pb-20">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-10">
            <ProductCard name="12 Inch EVA Foam" image={prod1} />
            ...
            <ProductCard name="Front Basket V1" image={prod3} />
            ...
            <ProductCard name="Lady-Chain Cover V2" image={prod12} />
            <ProductCard name="Sharp Chain" image={prod10} />
            <ProductCard name="Sports Bottle" image={bottleBase} />
            <ProductCard name="Sports Bottle V1" image={prod4} />
            <ProductCard name="Sports Bottle V2" image={prod8} />
            <ProductCard name="Sports Bottle V4" image={bottle4} />
          </div>
        </div>
